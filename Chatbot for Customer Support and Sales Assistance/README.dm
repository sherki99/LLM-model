...
### How It Works:
- The chatbot appends each user message to the conversation history.
- If the word “belt” appears, it adds additional context to the conversation.
- It streams responses back to the user in real-time.
